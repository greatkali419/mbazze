    ...
    style={{
      ...
      height: '100vh'
        ...
        className='flex-col align-middle pt-24 md:pt-12 p-5 md:px-[8%]' >
            <h1 className=" pt-44 md:pt-56 text-[2.5rem] md:text-[3rem] md:pr-[45%] md:text-left text-bcolor font-extrabold"> Discover and explore The world of digital media marketing</h1>
