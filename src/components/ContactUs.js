...
export default function ContactUs() {
  ...
  return (
    <div>
          <div className="bg-black text-white  mt-14 pt-12 md:pt-28">
      <div className='flex justify-center my-6'>
        ...
        <div className='grid grid-flow-row md:grid-flow-col md:grid-cols-3 justify-center py-12 w-[90%] mx-auto gap-4'>
            <motion.section
         animate={animation}
         className="p-4 my-8 mx-4 shadow-lg shadow-[#0000002c] flex-col gap-4 rounded-xl hover:shadow-lg hover:shadow-bcolor border-2 border-color">
                ...
                <a className="text-color block text-lg font-semibold tracking-wider" href='tel: +2347031447386'>
                  +2347031447386
                </a>
                <a 
                 className="text-color block text-lg font-semibold tracking-wider"
            ...
            animate={animation1}
            className="p-4 my-8 mx-4 shadow-lg shadow-[#0000002c] flex-col gap-4 rounded-xl hover:shadow-lg hover:shadow-bcolor  border-2 border-color">
                <AiOutlineMail  className="h-10 w-10 my-6 mx-2"/>
            ...
            animate={animation}
            className="p-4 my-8 mx-4 shadow-lg shadow-[#0000002c] flex-col gap-4 rounded-xl hover:shadow-lg hover:shadow-bcolor  border-2 border-color">
                  <FaAddressCard className="h-10 w-10 my-6 mx-2" />
                  ...
                  <article className="flex mx-2">
                      ...
                      <p  className="text-color block text-lg font-semibold tracking-wider mx-2 text-right">
